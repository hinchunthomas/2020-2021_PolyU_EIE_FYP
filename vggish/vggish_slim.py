...
def define_vggish_slim(features_tensor=None, training=False):
  ...
  input is expected to have dtype float32 and shape [batch_size, num_frames(96),
  num_bands(64)] where batch_size is variable and num_frames and num_bands are
  ...
  with slim.arg_scope([slim.conv2d, slim.fully_connected],
    ...
    # [-1] => flattern that dimension into 1-D (cutting into half)
    # x Number of value in the [] => xD
